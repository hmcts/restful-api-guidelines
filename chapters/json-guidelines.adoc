...
These guidelines provides recommendations for defining JSON data at HMCTS.
...
The guidelines clarifies some specific cases to allow HMCTS JSON data to have
