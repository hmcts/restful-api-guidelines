...
tend to be less use-case specific and comes with less rigid client/server
coupling and are more suitable as a platform interface being open for
...
We apply the RESTful service principles to all kinds of application
components, whether they provide functionality via the public nternet or
via internal networks as larger application elements. We strive to build
